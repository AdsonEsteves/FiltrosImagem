...
public:
	...
	static Mat juntarImagens(Mat imagemRed, Mat imagemGreen, Mat imagemBlue);
	static Mat escalaAzul(Mat imagemColorida);
	...
	static Mat agucamento(Mat imagemBase);
	static int ** kernelCentroPositivo();
	static Mat Erosao(Mat imagemBase);
